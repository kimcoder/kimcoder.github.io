      ...
      <div className='container mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8'>
        <div className='grid-cols-2 md:grid xl:grid-cols-4 md:gap-8'>
          ...
          <div className='mt-12 md:mt-0'>
            <h4 className='text-sm leading-5 font-semibold tracking-wider text-gray-400 uppercase'>Community</h4>
            <ul className='mt-4'>
              <li className='mt-4'>
                <a
              ...
              <li className='mt-4'>
                <a href='https://discord.gg/WrRKjPJ' className='text-base leading-6 text-gray-500 hover:text-gray-900'>
                  #TanStack Discord
                </a>
              </li>
              <li className='mt-4'>
          ...
          <div className='mt-8 xl:mt-0'>
            ...
            <form
              ...
              <div data-element='fields' className='seva-fields grid grid-cols-3 gap-2 max-w-lg'>
                <input
              ...
              <div data-element='guarantee' className='formkit-guarantee text-gray-400 text-xs mt-4'>
        ...
        <div className='mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between'>
          <div className='flex md:order-2'>
            <a href='https://twitter.com/tannerlinsley' className='ml-6 text-gray-400 hover:text-gray-500'>
              <span className='sr-only'>Twitter</span>
              <svg className='h-6 w-6' fill='currentColor' viewBox='0 0 24 24'>
                <path d='M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84' />
              </svg>
            </a>
            <a href='https://github.com/tannerlinsley' className='ml-6 text-gray-400 hover:text-gray-500'>

...
const Home = ({ sponsors }) => {
  return (
    <>
      <Seo title='React Query' description='Hooks for fetching, caching and updating asynchronous data in React' />
      <Head>
        <title>React Query - Hooks for fetching, caching and updating asynchronous data in React</title>
      </Head>
              ...
              <div className='col-span-12 lg:col-span-6 '>
                <div className='text-center lg:text-left md:max-w-2xl md:mx-auto '>
                  <h1 className='text-4xl tracking-tight leading-10 font-extrabold text-gray-900 sm:leading-none sm:text-6xl lg:text-5xl xl:text-6xl'>
                    ...
                    <br className='hidden md:inline xl:hidden' /> <span>synchronization for React</span>
                  </h1>
                  <p className='mt-3 text-base text-gray-700 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl'>
                    Fetch, cache and update data in your React and React Native applications all without touching any
                    "global state".
                  </p>
          ...
          <div className='py-24  '>
            <div className='mx-auto container'>
              <div className='lg:grid lg:grid-cols-3 lg:gap-8'>
                <div>
                  <div>
                    <h3 className='text-xl leading-6 xl:text-2xl font-bold text-gray-900'>Declarative & Automatic</h3>
                    <p className='mt-2 lg:mt-4 text-base xl:text-lg lg:leading-normal leading-6 text-gray-600'>
                      Writing your data fetching logic by hand is over. Tell React Query where to get your data and how
                      fresh you need it to be and the rest is automatic. React Query handles caching, background updates
                      and stale data out of the box with zero-configuration.
                    </p>
                  </div>
                </div>
                <div className='mt-10 lg:mt-0'>
                  <div>
                    <h3 className='text-xl leading-6 xl:text-2xl font-bold text-gray-900'>Simple & Familiar</h3>
                    <p className='mt-2  lg:mt-4 text-base xl:text-lg lg:leading-normal leading-6 text-gray-600'>
                      If you know how to work with promises or async/await, then you already know how to use React
                      Query. There's no global state to manage, reducers, normalization systems or heavy configurations
                      to understand. Simply pass a function that resolves your data (or throws an error) and the rest is
                      history.
                    </p>
                  </div>
                </div>
                <div className='mt-10 lg:mt-0'>
                  <div>
                    <h3 className='text-xl leading-6 xl:text-2xl font-bold text-gray-900'>Powerful & Configurable</h3>
                    <p className='mt-2  lg:mt-4 text-base xl:text-lg lg:leading-normal leading-6 text-gray-600'>
                      React Query is configurable down to each observer instance of a query with knobs and options to
                      fit every use-case. It comes wired up with dedicated devtools, infinite-loading APIs, and first
                      class mutation tools that make updating your data a breeze. Don't worry though, everything is
        ...
        <div className='bg-gray-900 text-white'>
          <div className='py-32'>
            <div className='mx-auto container text-center'>
              ...
              <div className='text-3xl md:text-5xl font-bold'>React Query Essentials</div>
              <div className='text-xl italic'>
                The <strong>official</strong> React Query course by <strong>Tanner Linsley</strong>
              </div>
              <a
        ...
        <div className='relative text-lg border-t border-gray-200 bg-gray-100 overflow-hidden'>
          <div className='lg:block lg:absolute lg:inset-0'>
            <svg
              ...
              <rect x='0' width='2400' height='2400' fill='url(#9ebea6f4-a1f5-4d96-8c4e-4c2abf658047)' />
            </svg>
          </div>
        ...
        <div className='bg-gray-100 relative py-24 border-t border-gray-200 '>
          <div className='px-4 sm:px-6 lg:px-8  mx-auto container max-w-3xl sm:text-center'>
            ...
            <p className='my-4 text-xl leading-7  text-gray-600'>
              Instead of writing reducers, caching logic, timers, retry logic, complex async/await scripting (I could
              keep going...), you literally write a tiny fraction of the code you normally would. You will be surprised
              at how little code you're writing or how much code you're deleting when you use React Query.
            </p>
          </div>
          <div
            style={{
          ...
          <div className='py-24 px-4 sm:px-6 lg:px-8  mx-auto container'>
            <div className=' sm:text-center pb-16'>
              ...
              <p className='mt-4 text-xl max-w-3xl mx-auto leading-7 text-gray-300'>
                With React as the only dependency, React Query is extremely lean, but also strategically packed to the
                brim with features you're bound to need in almost any project. From weekend hobbies all the way up to
                enterprise e-commerce systems (lookin' at you Walmart!), React Query is jam packed with battle-hardened
